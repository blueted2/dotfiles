...
let carapace_bash_bridge = {|spans| 
  {
    $spans.0: { } # default
    nushell: { carapace-bridge _carapace nushell '' bash $spans | from json }
...
let-env config = {
  ...
  completions: {
    ...
    external: {
      ...
      completer: $carapace_bash_bridge # check 'carapace_completer' above as an example
      # completer: null
    }
  }
  filesize: {
